 ...
 *
 * 위와 같은 문제를 해결하기 위해 타입스크립트가 탄생했습니다.
 *
 *  */

/** 타입스크립트
 * 타입스크립트는 종종 '자바스크립트의 상위 집합' 혹은 '타입이 있는 자바스크립트'라고 설명되곤 합니다.
 * 타입스크립트란 무엇일까요?
 *
 ...
 * 코드를 지정한 방법으로만 사용하도록 제한한다면, 타입스크립트는 코드의 한 영역을 변경하더라도 이 코드를 사용하는 다른 코드의 영역이 멈추지 않는다는 확신을 줄 수 있습니다.
 *
 * 1.4 로컬에서 시작하기
